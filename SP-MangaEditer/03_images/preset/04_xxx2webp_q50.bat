...
for %%F in ("%input_dir%\*.png") do (
    ...
    ffmpeg -i "!input_file!" -vf "!filter_complex!" -quality !quality! "!output_file!"
    
    REM 変換完了メッセージ
    echo Conversion complete: "!output_file!"
)

echo All PNG files have been resized and converted to WebP with quality setting of %quality%.
pause